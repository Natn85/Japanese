  ...
  return (
    ...
    >
      {/* Always faintly visible so touch users discover the cards speak;
          hover (where it exists) brightens it. */}
      <SpeakerIcon className="absolute right-1.5 top-1.5 h-3.5 w-3.5 text-ink-muted opacity-40 transition-opacity duration-150 group-hover:opacity-100 group-hover:text-accent" />
      <span className="font-jp text-4xl font-bold leading-none text-ink transition-colors group-hover:text-accent" lang="ja">
        {entry.kana}
      </span>
